...
# Submit the four 2026-07-24 CRPS ambient evaluations after their corresponding
# training jobs leave the queue.
#
# The checkpoint is intentionally resolved inside the allocated evaluation job,
# after its afterany dependency is satisfied. This avoids pinning whichever
# best-multiwinkler-overall checkpoint happens to exist at submission time.
# Resolution is strict: exactly one best-multiwinkler-overall-*.ckpt must exist.
#
# afterany is intentional. If training fails, the evaluation job will still be
# released; the deferred checkpoint check then exits clearly when no valid
# overall-best checkpoint exists.
#
# Preview all four submissions without queueing anything:
#   ./slurm_scripts/comparison/eval/submit_eval_crps_ambient_best_multiwinkler_overall_2026_07_24.sh
#
# Queue them:
#   SUBMIT=true ./slurm_scripts/comparison/eval/submit_eval_crps_ambient_best_multiwinkler_overall_2026_07_24.sh

EVAL_BATCH_SIZE=8
EVAL_N_MEMBERS=10
# Comparable successful evaluations, including snapshots, took 4-11 minutes.
# Keep more than 4x the slowest observed runtime.
TIMEOUT_MIN=45
MEMORY="115G"
...
run_deferred_eval() {
    ...
    echo "Starting deferred CRPS ambient evaluation"
...
RUNS=(
    "crps_ad|5773775|crps_ad64_vit_azula_large_103985e_dca5712"
    "crps_gs|5773777|crps_gs64_vit_azula_large_103985e_8a8aec0"
    "crps_gpe|5773778|crps_gpe64_vit_azula_large_103985e_6d2adc5"
    "crps_cns|5773779|crps_cns64_vit_azula_large_103985e_6360e51"
)
