...
set -euo pipefail
# Temporary eval submitter for the 2026-04-20_part CNS CRPS ensemble-size
# ablations. These are ambient/EPD checkpoints with model.n_members=16, kept
# separate from the main ambient eval script until the ablation set settles.
#
