...
readonly CACHE_BATCH_SCRIPT="${PIPELINE_SCRIPT_DIR}/03_cache_latents_short_batch.sh"
...
echo "Short-cache new-AE dependency chain"
echo "  AE job: ${AE_JOB_ID}"
echo "  cache dependency: afterany:${AE_JOB_ID}"
echo "  cache allocation: 1 GPU, 00:10:00, normal batch queue"
