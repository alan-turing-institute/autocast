...
# LoLA-style Rayleigh-Benard latent masked-window flow-matching ViT-large run.
...
for run_dry in "${RUN_DRY_STATES[@]}"; do
    ...
    echo "Submitting LoLA-style Rayleigh-Benard masked-window FM ViT-large training"
    echo "  mode: ${run_label}"
    ...
    uv run autocast processor --mode slurm "${dry_run_arg[@]}" \
        ...
        # Can't log to wandb at the moment
