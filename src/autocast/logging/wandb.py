...
def create_notebook_logger(
    ...
    *,
    ...
    Args:
        project (str, optional): W&B project name (default: "autocast-notebooks")
        name (str, optional): Run name (default: auto-generated by wandb)
        enabled (bool, optional): Whether to enable wandb logging (default: True)
        tags (list[str], optional): Tags to attach to the run
        watch (str, optional): Model watching mode: "gradients", "parameters", "all", or None to disable
    Returns:
