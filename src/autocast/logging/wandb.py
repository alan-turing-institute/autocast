...
def create_notebook_logger(
    ...
    *,
    ...
    Args:
        project: W&B project name (default: "autocast-notebooks")
        name: Run name (default: auto-generated by wandb)
        enabled: Whether to enable wandb logging (default: True)
    ...
    Returns:
        ...
        watch_cfg : Watch configuration for use with maybe_watch_model, or
            None if disabled
    Examples:
